...
<html>
  ...
  <body>
    ...
    <div class="container">
      ...
      <p class="h1" style="text-align:center;">Sorry, this page does not exist (404).</p>
      <p style="color:#d8d8d8; text-align:center;"><a href="index.php">return to safety</a></p>

      <br><div style="border-bottom: solid rgb(204, 204, 158) 1px"></div><br>
